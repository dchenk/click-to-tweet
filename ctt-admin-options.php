			...
			<div class="ctt-mrsetting">
				...
				<div class="tab">
					<div id="tab-1" class="tab-content" style="display:block">
						<?php require_once(__DIR__ . '/view/ctt-settings.php');	?>
					</div>
					<div id="tab-2" class="tab-content">
						<?php require_once(__DIR__ . '/view/box-design.php'); ?>
					</div>
					<div id="tab-3" class="tab-content">
						<?php require_once(__DIR__ . '/view/image-box.php'); ?>
					</div>
					<div id="tab-4" class="tab-content">
						<?php require_once(__DIR__ . '/view/hint-box.php'); ?>
					</div>
					<div id="tab-5" class="tab-content">
						<?php require_once(__DIR__ . '/view/author-box.php'); ?>
					</div>
				</div>
			</div>
		</div>
