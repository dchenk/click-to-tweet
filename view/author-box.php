<div class="dis-hint">
	<div class="set-output">
		...
		<div id="col-pe-13" class="col-preview" style="display: block;">
			<div class="author-first-inner">
				...
				<div class="tweet-text">
					<p class="ctt-font-<?php echo $bopt['atr_13']['font_size']; ?>">This is a test of CTT - cool
						Wordpress plugin for creating tweetable quotes </p>
					<div class="lower-btn">
						<label class="auth-lbl"><?php echo $bopt['atr_13']['author']; ?></label>
						<a href="#"><span class="cta-pr"
								data-cta="<?php echo $bopt['atr_13']['callforaction']; ?>"><?php echo $bopt['atr_13']['callforaction']; ?></span></a>
					</div>
				</div>
			...
			<div class="author-second-inner">
				...
				<div class="tweet-text">
					...
					<div class="lower-btn">
						...
						<a href="#"><span class="cta-pr"
								data-cta="<?php echo $bopt['atr_14']['callforaction']; ?>"><?php echo $bopt['atr_14']['callforaction']; ?></span></a>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
		...
		<div id="col-pe-15" class="col-preview">
			<div class="author-third-inner">
				...
				<div class="tweet-text">
					<blockquote class="style1"><p class="ctt-font-<?php echo $bopt['atr_13']['font_size']; ?>">This is a
							test of CTT - cool Wordpress plugin for creating tweetable quotes <span
								class="tw-ico"> </span></p></blockquote>
					<div class="lower-btn">
	...
	<div class="set-settings">
		...
		<form method="post" onsubmit="return save_auth_box_setting(this);"
			...
			<div class="row ctoa">
				...
				<input type="text" name="cta-txt" value="<?php echo $bopt['atr_13']['callforaction']; ?>"
